...
Special thanks to [caoxiemeihao](https://github.com/caoxiemeihao) for almost the entire code base, i just modified a small part to make it work with SolidJS. Original code can be found [here](https://github.com/caoxiemeihao/vite-react-electron)# VendleElectron
